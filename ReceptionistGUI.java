...
class ReceptionistGUI extends JFrame {
    ...
    private void setupUI() {
        ...
        homeItem.addActionListener(_ -> showHomePage());
    ...
    private JPanel createHomePage() {
        ...
        registerBtn.addActionListener(_ -> cardLayout.show(mainPanel, "REGISTER"));

        JButton updateBtn = createMenuButton("Update Student Enrollment");
        updateBtn.addActionListener(_ -> cardLayout.show(mainPanel, "UPDATE"));

        JButton paymentBtn = createMenuButton("Accept Payment");
        paymentBtn.addActionListener(_ -> cardLayout.show(mainPanel, "PAYMENT"));

        JButton deleteBtn = createMenuButton("Delete Student Record");
        deleteBtn.addActionListener(_ -> cardLayout.show(mainPanel, "DELETE"));

        JButton profileBtn = createMenuButton("Update My Profile");
        profileBtn.addActionListener(_ -> cardLayout.show(mainPanel, "PROFILE"));
    ...
    private JPanel createBackButtonPanel() {
        ...
        backButton.addActionListener(_ -> showHomePage());
    ...
    private JPanel createRegisterPanel() {
        ...
        courseCombo.addActionListener(_ -> updateSubjects(courseCombo, subject1, subject2, subject3));
    ...
    private JPanel createUpdatePanel() {
        ...
        studentTable.getSelectionModel().addListSelectionListener(_ -> {
